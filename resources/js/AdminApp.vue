  ...
  <div class="cb-dashboard">
    <div class="cb-container">
      <header class="cb-header">
        <svg class="cb-logo" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"
          aria-label="CB Fake Post Ai Logo">
          <circle cx="20" cy="20" r="20" fill="#008080" />
          <path d="M7 33 L33 7" stroke="#fff" stroke-width="3.2" stroke-linecap="round" />
          <path d="M32 20c0 6.627-5.373 12-12 12S8 26.627 8 20 13.373 8 20 8" stroke="#fff" stroke-width="2.2"
            fill="none" />
        </svg>
      ...
      <div class="cb-tabs-container">
        <nav class="cb-tabs">
          <button v-for="tab in tabs" :key="tab" :class="['cb-tab', { active: activeTab === tab }]"
